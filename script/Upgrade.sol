...
contract Upgrade is Script, Fork {
    ...
    function upgradeSynthDataProvider() public {
        ...
        SynthDataProvider.SynthData[] memory data = SynthDataProvider(
            synthDataProvider
        ).synthsData(address(0x0));
    ...
    function upgradePoolDataProvider() public {
        address poolDataProvider = fileUtils.readContractAddress(
            chainId,
            "poolDataProvider"
        );
        ...
        PoolDataProvider(poolDataProvider).upgradeToAndCall(
