...
contract Deploy {
    ...
    function _deployProvider(address _owner) internal returns (Provider) {
        ...
        ERC1967Proxy proxy = new ERC1967Proxy(
            ...
            abi.encodeWithSelector(
                providerImplementation.initialize.selector,
                _owner
            )
        );
    ...
    function _deployXUSD(
        ...
        IExchanger(IProvider(_provider).exchanger()).addNewSynth(
            address(proxy)
        );
    ...
    function _createSynth(
        ...
        address newSynth = Provider(_provider).exchanger().createSynth(
            _implementation,
            _owner,
            _name,
            _symbol
    ...
    function _deployPool(
        ...
        ERC1967Proxy proxy = new ERC1967Proxy(
            ...
            abi.encodeWithSignature(
                "initialize(address,address,address,address,uint32,uint32,uint32,uint32,uint32,uint32)",
                _owner,
                _provider,
                _weth,
                _debtShares,
    ...
    function _deployDiaOracleAdapter(
        ...
        address _provider,
        address _diaOracle
    ) internal returns (DiaOracleAdapter) {
    ...
    function _deployPoolDataProvider(
        address _owner,
        address _provider
    ) internal returns (PoolDataProvider) {
    ...
    function _deploySynthDataProvider(
        address _owner,
        address _provider
    ) internal returns (SynthDataProvider) {
