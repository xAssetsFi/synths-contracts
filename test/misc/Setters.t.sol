...
contract SettersTest is Setup {
    ...
    function test_setExchanger() public {
        Exchanger newExchanger = _deployExchanger(
            address(this),
            address(provider),
            1,
            1,
    ...
    function test_setOracle() public {
        DiaOracleAdapter newOracle = _deployDiaOracleAdapter(
            address(this),
            address(provider),
            address(diaOracle)
        );
    ...
    function test_setFallbackOracle() public {
        DiaOracleAdapter fallbackOracle = _deployDiaOracleAdapter(
            address(this),
            address(provider),
            address(diaOracle)
        );
        ...
        assertEq(
            address(oracleAdapter.fallbackOracle()),
