...
contract PoolDataProviderTest is PoolDataProviderSetup {
    ...
    function test_maxWithdraw_allowAllAmount() public view {
        (uint256 tokenAmount, uint256 dollarAmount) = poolDataProvider
            .maxWithdraw(address(this), address(usdc));
    ...
    function test_maxBorrow_withLowHf() public {
        uint256 maxBorrowBeforeBorrow = poolDataProvider.maxXUSDBorrow(
            address(this)
        );
        ...
        assertLt(
            poolDataProvider.getHealthFactor(address(this)),
    ...
    function test_getAggregatedPoolData_nonEmptyState() public {
        ...
        IPoolDataProvider.AggregatedPoolData memory data = poolDataProvider
            .getAggregatedPoolData(address(this));
        ...
        assertEq(
            data.poolData.debtSharesBalance,
            debtShares.balanceOf(address(this))
        );
        assertEq(
            data.poolData.minHealthFactorForBorrow,
            pool.getMinHealthFactorForBorrow()
        );
    ...
    function test_reCalcHF_supply_sameToken() public {
        ...
        PoolDataProvider.ReCalcHfParams memory params = IPoolDataProvider
            .ReCalcHfParams(collateralToken, collateralAmount, 0);
    ...
    function test_reCalcHF_withdraw() public {
        ...
        PoolDataProvider.ReCalcHfParams memory params = IPoolDataProvider
            .ReCalcHfParams(collateralToken, withdrawAmount, 0);
    ...
    function test_reCalcHF_borrow() public {
        ...
        PoolDataProvider.ReCalcHfParams memory params = IPoolDataProvider
            .ReCalcHfParams(address(0), 0, borrowAmount);
    ...
    function test_reCalcHF_repay() public {
        ...
        PoolDataProvider.ReCalcHfParams memory params = IPoolDataProvider
            .ReCalcHfParams(address(0), 0, repayAmount);
