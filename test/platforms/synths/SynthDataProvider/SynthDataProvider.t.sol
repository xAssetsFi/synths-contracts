...
contract SynthDataProviderTest is SynthDataProviderSetup {
    function test_synthData() public view {
        ISynthDataProvider.SynthData[] memory data = synthDataProvider
            .synthsData(address(this));

        assertEq(data.length, 3);
    }

    function test_aggregateSynthData() public view {
        ISynthDataProvider.AggregateSynthData memory data = synthDataProvider
            .aggregateSynthData(address(this));
